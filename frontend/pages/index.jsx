...
export default function Home() {
    return (
        <>
            ...
            <section class="h-50 bg-white dark:bg-gray-900">
                <div class="gap-8 columns-2 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                    <div class="mt-4 md:mt-0">
                        ...
                        <a href="#retailSection" class="inline-flex items-center text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-purple-900">
                            Get started
            ...
            <section id="retailSection" class="bg-white dark:bg-gray-900">
