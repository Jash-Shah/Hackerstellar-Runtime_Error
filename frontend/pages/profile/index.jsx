...
const Index = () => {
  ...
  return (
    <div className="dark:bg-slate-800">
      <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto lg:my-0 dark:bg-slate-800">
        {/* <!--Main Col--> */}
        <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">


          <div class="p-4 mt-8 md:p-12 text-center lg:text-left">
            {/* <!-- Image for mobile view--> */}
            <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center">
              <img src="/profile/user.jpg" className="rounded-3xl lg:rounded-lg shadow-2xl lg:block" />
            </div>

            <h1 class="text-2xl  pt-8 lg:pt-0">Hello, {userName}</h1>
            {/* <h1 class="text-3xl font-bold lg:pt-0">{userName}</h1> */}
