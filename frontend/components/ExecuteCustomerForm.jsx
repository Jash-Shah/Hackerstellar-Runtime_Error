...
function RegisterForm() {
    ...
    const onFinish = async values => {
        try {
            ...
            const execute = await wallet.contract.signProduct_customer(
                values.productID,
                false,
            );
    ...
    return (
        <>
            <Form
                ...
                autoComplete="off">
                <div className="flex">
                    <h5 class="m-auto mb-4 text-xl font-medium dark:text-white underline-offset-4 underline text-green-700">
                        Execute for Customer
                    </h5>
                </div>
